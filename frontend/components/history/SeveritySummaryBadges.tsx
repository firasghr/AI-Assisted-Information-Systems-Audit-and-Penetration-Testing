...
const SEVERITY_STYLES: Record<SeverityKey, { bg: string; text: string; label: string }> = {
  critical:      { bg: "bg-red-100",    text: "text-red-700",    label: "C" },
  high:          { bg: "bg-orange-100", text: "text-orange-700", label: "H" },
  medium:        { bg: "bg-yellow-100", text: "text-yellow-700", label: "M" },
  low:           { bg: "bg-green-100",  text: "text-green-700",  label: "L" },
  informational: { bg: "bg-slate-100",  text: "text-slate-600",  label: "I" },
};
